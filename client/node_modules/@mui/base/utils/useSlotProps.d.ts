...
import { MergeSlotPropsParameters, WithCommonProps } from '@mui/base/utils/mergeSlotProps';
 ...
 */
export default function useSlotProps<ElementType extends React.ElementType, SlotProps, ExternalForwardedProps, ExternalSlotProps, AdditionalProps, OwnerState>(parameters: UseSlotPropsParameters<ElementType, SlotProps, ExternalForwardedProps, WithCommonProps<ExternalSlotProps>, WithCommonProps<AdditionalProps>, OwnerState>): import("@mui/types").Simplify<import("@mui/types").Simplify<SlotProps & import("@mui/base/utils/omitEventHandlers").OmitEventHandlers<Record<string, unknown>> & AdditionalProps & {
    className?: string | undefined;
